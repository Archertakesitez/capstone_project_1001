...
Our solutions are included in [capstone_DS14.pdf](https://drive.google.com/file/d/1IE_wfbnaCg4QZVO0S_xKCXisNze7_7r8/view?usp=sharing) and their assocaited codes are included in both [capstone_ds14.ipynb](/capstone_ds14.ipynb) and [DS14_code.py](/DS14_code.py). You can choose either the .ipynb or the .py file to review and run our codes. 
